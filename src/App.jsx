      ...
      >
        ...
        {isInstalled && (
          <div className="install-success">
            ...
            {/* Estilos migrados a src/styles/App.css */}
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
                <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
                   <img src="/active_logo.png" alt="Logo" style={{ width: 48, height: 48, objectFit: 'contain' }} />
              ...
              <div className="main-brand-display" style={{ marginTop: 30, position: 'relative' }}>
                ...
                >
                  <img src={userProfile?.organization?.logo_url || "/active_logo.png"} alt="Logo" className="active-response-logo" style={{ width: 130, height: 130, filter: 'drop-shadow(0 10px 20px rgba(0,0,0,0.5))' }} />
                </motion.div>
